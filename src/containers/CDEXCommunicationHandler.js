...
class CDEXCommunicationHandler extends Component {
    constructor(props) {
        super(props);
        this.state = {
            patient: null,
    ...
    async componentDidMount() {
        if (!sessionStorage.getItem('isLoggedIn')) {
            sessionStorage.setItem('redirectTo', "/cdex_documents");
...
export default withRouter(connect(mapStateToProps)(CDEXCommunicationHandler));
